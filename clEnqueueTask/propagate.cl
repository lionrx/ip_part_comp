...
__kernel void propagate(
	...
	// Temp in Velocity
	// Both stored in w
	__private const float tau, //4
	__private const float A, //5
	__private const float a, //6
	__private const float B, //7
	__private const float b, //8
	__private const float C, //9
	__private const float c, //10
	__private const float timeStep, //11
	__private const float C_l, //12
	__private const float T_g, //13
	__private const float P_atm, //14
	__private const float P_g, //15
	__private const float rho, //16
	__private const float R, //17
	__private const float W_c, //18
	__private const float W_v, //19
	__private const float T_B, //20
	__private const float rho_g, //21
	__private const float TWB, //22
	__private const double mu, //23
	__private const float Y_g, //24
	const int count //25
)
{
